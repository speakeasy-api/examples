...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetOrdersOrdersGetRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.CoffeeOrder$inboundSchema)),
