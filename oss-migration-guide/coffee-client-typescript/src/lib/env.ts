...
export interface Env {
  COFFEECLIENT_API_KEY_AUTH?: string | undefined;

  COFFEECLIENT_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  COFFEECLIENT_API_KEY_AUTH: z.string().optional(),

  COFFEECLIENT_DEBUG: z.coerce.boolean().optional(),
});
