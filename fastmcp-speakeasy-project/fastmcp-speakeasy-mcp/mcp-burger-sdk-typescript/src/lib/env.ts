...
export interface Env {
  MCPBURGERSDK_API_KEY?: string | undefined;

  MCPBURGERSDK_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  MCPBURGERSDK_API_KEY: z.string().optional(),

  MCPBURGERSDK_DEBUG: z.coerce.boolean().optional(),
});
