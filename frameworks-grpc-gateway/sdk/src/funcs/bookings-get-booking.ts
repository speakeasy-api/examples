 ...
 */
export function bookingsGetBooking(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetBookingRequest$outboundSchema, value),
  ...
  >(
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetBookingResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
