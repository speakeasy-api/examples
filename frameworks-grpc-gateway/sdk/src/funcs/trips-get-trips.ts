...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetTripsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/trips")();
  ...
  >(
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetTripsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
