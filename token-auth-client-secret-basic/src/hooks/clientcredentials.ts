  ...
  implements SDKInitHook, BeforeRequestHook, AfterErrorHook
{
  ...
  private async getCredentialsGlobal(
    ...
    return {
      clientID: out?.clientID ?? env().TOKENAUTHCLIENTSECRETBASIC_CLIENT_ID
        ?? "",
      clientSecret: out?.clientSecret
        ?? env().TOKENAUTHCLIENTSECRETBASIC_CLIENT_SECRET ?? "",
      tokenURL: out?.tokenURL ?? env().TOKENAUTHCLIENTSECRETBASIC_TOKEN_URL
        ?? "",
    };
  }
