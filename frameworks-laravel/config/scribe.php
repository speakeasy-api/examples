...
return [
    ...
    'description' => ' API for managing Formula 1 races, drivers, and circuits',
    ...
    // Generate an OpenAPI spec (v3.1.x) in addition to docs webpage.
    ...
    'openapi' => [
        ...
        // Set OpenAPI output version.
        'version' => '3.1.0',

        'overrides' => [
            'info.contact' => [
                'name' => 'API Support',
                'email' => 'support@f1races.com',
            ],
        ],
