...
export const tripSchema = t.Object(
  {
    id: t.String({ format: 'uuid', example: 'ea399ba1-6d95-433f-92d1-83f67b775594' }),
    ...
    departure_time: t.String({ format: 'date-time', example: '2024-02-01T10:00:00Z' }),
    arrival_time: t.String({ format: 'date-time', example: '2024-02-01T16:00:00Z' }),
...
export const linksSelfSchema = t.Object({
  self: t.String({ format: 'uri', example: 'https://api.example.com/bookings/1725ff48-ab45-4bb5-9d02-88745177dedb' }),
});

export const linksPaginationSchema = t.Object({
  next: t.Optional(t.String({ format: 'uri', example: 'https://api.example.com/bookings?page=2' })),
  prev: t.Optional(t.String({ format: 'uri', example: 'https://api.example.com/bookings?page=1' })),
});
