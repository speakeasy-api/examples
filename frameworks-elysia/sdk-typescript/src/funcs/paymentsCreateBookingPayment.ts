 ...
 */
export function paymentsCreateBookingPayment(
  client: SDKCore,
  request: operations.CreateBookingPaymentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateBookingPaymentResponseBody,
    | errors.CreateBookingPaymentResponseBody
    | SDKError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateBookingPaymentResponseBody$inboundSchema),
    M.jsonErr(404, errors.CreateBookingPaymentResponseBody$inboundSchema, {
