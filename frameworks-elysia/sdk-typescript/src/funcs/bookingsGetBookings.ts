...
export function bookingsGetBookings(
  ...
  Result<
    ...
    | errors.GetBookingsResponseBody
    | errors.GetBookingsBookingsResponseBody
    | SDKError
...
> {
  ...
  >(
    ...
    M.jsonErr(401, errors.GetBookingsResponseBody$inboundSchema, {
      ctype: "application/problem+json",
    }),
    M.jsonErr(500, errors.GetBookingsBookingsResponseBody$inboundSchema, {
      ctype: "application/problem+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
