...
```typescript
import { CreateBookingRawXMLResponseBody } from "train-travel-sdk/models/operations";

let value: CreateBookingRawXMLResponseBody = {
...
| `links`                                        | [models.LinksSelf](../../models/linksself.md)  | :heavy_minus_sign:                             | The link to the current resource.              |                                                |