...
import { TrainTravelSDKDefaultError } from "../models/errors/traintravelsdkdefaulterror.js";
...
export function match<T, E>(
...
): MatchFunc<T, E | TrainTravelSDKDefaultError | ResponseValidationError> {
  return async function matchFunc(
    ...
    [
      result: Result<
        T,
        E | TrainTravelSDKDefaultError | ResponseValidationError
      >,
      raw: unknown,
    ]
  > {
    ...
    if (!matcher) {
      return [{
        ok: false,
        error: new TrainTravelSDKDefaultError(
    ...
    if (matcher.enc === "fail") {
      return [{
        ok: false,
        error: new TrainTravelSDKDefaultError("API error occurred", {
          request,
          response,
          body,
        }),
