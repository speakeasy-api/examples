 ...
 */
export function systemGetHeartbeat(
  client: APICore,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.HeartbeatResponse,
    | errors.NotFound
    | errors.Unauthorized
    | errors.Timeout
    | errors.RateLimited
...
> {
  const path = pathToFunc("/api/v2/heartbeat")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.HeartbeatResponse$inboundSchema),
