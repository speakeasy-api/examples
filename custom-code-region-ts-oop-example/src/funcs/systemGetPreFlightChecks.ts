 ...
 */
export function systemGetPreFlightChecks(
  client: APICore,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ChecklistResponse,
    | errors.NotFound
    | errors.Unauthorized
    | errors.Timeout
    | errors.RateLimited
...
> {
  const path = pathToFunc("/api/v2/pre-flight-checks")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ChecklistResponse$inboundSchema),
