...
export function collectionsUpdate(
  ...
  Result<
    components.UpdateCollectionResponse,
...
> {
  ...
  const body = encodeJSON("body", payload.UpdateCollectionPayload, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.UpdateCollectionResponse$inboundSchema),
