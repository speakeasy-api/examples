...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CollectionQueryRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.QueryRequestPayload, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.QueryResponse$inboundSchema),
